...
const InputBienPhapDT_DoiTuongStyled = styled.div`
  .ip-ls-old {
...
export default function InputBienPhapDT_DoiTuong() {
  ...
  return (
    <InputBienPhapDT_DoiTuongStyled className="container">
      ...
      <ModalDeleteData />
    </InputBienPhapDT_DoiTuongStyled>
  );
}
