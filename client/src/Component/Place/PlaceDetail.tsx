      ...
      <div className="place-dt-body">
        <div className="place-dt-header">
          ...
          <p>
            ...
            <b>{baocaoPHDC.ThoiGianPH && handleTime(baocaoPHDC.ThoiGianPH)}</b>
          </p>
          <p>
          ...
          <p>Hình ảnh:</p>
          <Link
            to={baocaoPHDC.HinhAnh}
            className="place-dt-img"
            target="_blank"
          >
        ...
        <div className="place-dt-result">
          ...
          <div className="place-dt-result-header">
            <div>
              <p>
                Họ tên chủ hộ:&emsp;{" "}
                <b>{baocaoPHDC.BaoCaoKQXMDiaChi?.HoTenChuHo}</b>
              </p>
              <p>
            ...
            <div>
              ...
              <p>
                Giới tính: &emsp;{" "}
                <b>
                  {baocaoPHDC.BaoCaoKQXMDiaChi?.GioiTinh === 1 ? "Nữ" : "Nam"}
                </b>
              </p>
              <p>
